...
<section class="max-w-[640px] w-full min-h-screen mx-auto flex flex-col bg-white overflow-x-hidden pb-[134px]">
        ...
        <div class="header flex flex-col bg-gradient-to-b from-[#3CBBDB] to-[#2F5BE0FF] rounded-b-[50px] overflow-hidden">
            ...
            <div class="mt-[30px] z-10">
                <h1 class="font-extrabold text-2xl leading-[36px] text-white text-center">Selamat Datang Di Jejak Kebaikan<br>Sudah Berbuat Baik Hari ini?</h1>
            </div>
        ...
        <div id="category-donasi" class="mt-8">
            <div class="px-4 flex justify-between items-center">
                <h2 class="font-bold text-lg">Bantu<br>Kategori Pilihanmu</h2>
        ...
        <div id="best-choices" class="mt-8 -mb-6">
            <div class="px-4 flex justify-between items-center">
                <h2 class="font-bold text-lg">Penggalangan Dana<br>Mendesak</h2>
                <a href="" class="p-[6px_12px] rounded-full bg-[#E8E9EE] font-semibold text-sm">Explore All</a>
            </div>
            <div class="main-carousel mt-[14px]">
        ...
        <div id="latest-fundrising" class="mt-8">
            <div class="px-4 flex justify-between items-center">
                <h2 class="font-bold text-lg">Pilihan Donasi<br>Untuk Kamu</h2>
                <a href="" class="p-[6px_12px] rounded-full bg-[#E8E9EE] font-semibold text-sm">Explore All</a>
            </div>
