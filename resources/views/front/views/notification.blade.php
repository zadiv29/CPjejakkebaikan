...
@section('content')
    <div class="flex h-screen w-full items-center justify-center py-16 text-center">
        <div
            ...
            <h1 class="mb-6 text-4xl font-extrabold tracking-tight text-gray-800">Terima kasih telah mendaftar!</h1>
            <div>

                <p class="mb-4 text-xl text-gray-700">Kami telah mengirimkan email verifikasi pembayaran ke alamat email
                    <strong>{{ $volunteer->email }}</strong> yang Anda masukkan sebagai penanggung jawab.
                </p>
