...
@section('content')
    <main class="flex min-h-screen w-full flex-col items-center">
        <div class="mx-auto max-w-xl space-y-7 rounded-lg bg-white p-4 shadow-md">
            <header class="relative grid grid-cols-[30%_auto] gap-5 rounded-lg bg-red-300 px-3 py-2">
                <lottie-player src="{{ asset('lottie/expired-payment.json') }}" background="transparent" speed="1"
                    class="sm:h-[150px] sm:w-[150px]" loop autoplay>
                </lottie-player>
                <div class="flex flex-col justify-center">
                    <section>
                        <h1 class="font-bold text-white sm:text-2xl">Pembayaran Kadaluarsa</h1>
                        <p class="text-sm text-white sm:text-base">Silahkan lakukan pembayaran berdasarkan metode yang
                            anda pilih</p>
                    </section>
