                ...
                <div class="item-card flex flex-col items-center justify-center gap-x-10 gap-y-10 md:flex-row">
                    ...
                    @role('owner|fundraiser')
                        ...
                        <div class="flex flex-col items-center gap-y-3 text-center">
                            ...
                            <div>
                                <p class="text-sm text-slate-500">Fundraisings</p>
                                <h3 class="text-xl font-bold text-indigo-950"> {{ $fundraisings }}</h3>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col items-center gap-y-3 text-center">
                            ...
                            <div>
                                ...
                                <h3 class="text-xl font-bold text-indigo-950"> {{ $withdrawals }} </h3>
                            </div>
                        </div>
                    @endrole
                    ...
                    @role('owner')
                        <div class="flex flex-col items-center gap-y-3 text-center">
                            ...
                            <div>
                                ...
                                <h3 class="text-xl font-bold text-indigo-950"> {{ $fundraisers }} </h3>
                            </div>
                        </div>
                        <div class="flex flex-col items-center gap-y-3 text-center">
                            <svg width="46" height="46" viewBox="0 0 24 24" fill="none"
