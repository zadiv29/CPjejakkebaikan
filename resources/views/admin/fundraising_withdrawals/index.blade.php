        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="flex flex-col gap-y-5 overflow-hidden bg-white p-10 shadow-sm sm:rounded-lg">
                ...
                @forelse($fundraising_withdrawals as $withdrawal)
                    <div class="item-card grid grid-cols-[5%_10%_20%_30%_auto_auto] items-center justify-between">
                        ...
                        @if ($withdrawal->has_sent)
                            ...
                            @else
                                <span class="w-fit rounded-full bg-indigo-500 px-3 py-2 text-sm font-bold text-white">
                                    PROCESSING
                                </span>
                            @endif
                        @else
