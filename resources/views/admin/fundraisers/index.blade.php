            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col ">
                <div class="item-card flex flex-col justify-between items-center gap-y-5">
                    ...
                    <div class="flex flex-col text-center">
                        <h3 class="text-indigo-950 text-xl font-bold">Buat Jejak Kebaikan</h3>
                        <p class="text-slate-500 text-base">Jadilah bagian dari kami untuk membantu <br>mereka yang membutuhkan bantuan kita</p>
                    </div>
